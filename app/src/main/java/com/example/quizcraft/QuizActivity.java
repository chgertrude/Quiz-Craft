...
public class QuizActivity extends AppCompatActivity {
    ...
    private void changeNextQuestion(){
        ...
        if(currentQuestionPosition < questionsList.size()){
            ...
            option1.setBackgroundResource(R.drawable.round_back_red_yellow_stroke);
            option1.setTextColor(Color.parseColor("#FFE000"));

            option2.setBackgroundResource(R.drawable.round_back_red_yellow_stroke);
            option2.setTextColor(Color.parseColor("#FFE000"));

            option3.setBackgroundResource(R.drawable.round_back_red_yellow_stroke);
            option3.setTextColor(Color.parseColor("#FFE000"));

            option4.setBackgroundResource(R.drawable.round_back_red_yellow_stroke);
            option4.setTextColor(Color.parseColor("#FFE000"));
    ...
    private void revealAnswer(){
        ...
        if(option1.getText().toString().equals(getAnswer)){
            option1.setBackgroundResource(R.drawable.round_back_yellow);
            option1.setTextColor(Color.BLACK);
        }else if(option2.getText().toString().equals(getAnswer)){
            option2.setBackgroundResource(R.drawable.round_back_yellow);
            option2.setTextColor(Color.BLACK);
        }else if(option3.getText().toString().equals(getAnswer)){
            option3.setBackgroundResource(R.drawable.round_back_yellow);
            option3.setTextColor(Color.BLACK);
        }else if(option4.getText().toString().equals(getAnswer)){
            option4.setBackgroundResource(R.drawable.round_back_yellow);
